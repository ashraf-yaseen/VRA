...
#self-defined
from bert_transfer.utils_bert2 import get_corpus_and_dict4

class DataProcess:
    def __init__(self, path = 'IIdata/', subpath = 'transfer/', load_pretrained = False, load_path = 'model_save_v4_transfer/', 
                 split = False, newSplit = True, names = ['immport', 'imspace', 'itnshare'], train_ratio = 50):
    ...
    def dataloaderize_(self, strategy = 'together'):
        ...
        if os.path.exists(self.path + self.subpath +'pub_corpus.pickle') and \
           os.path.exists(self.path + self.subpath +'pub_corpus_idls.pickle') and \
           os.path.exists(self.path + self.subpath +'data_corpus.pickle') and \
           os.path.exists(self.path + self.subpath +'data_corpus_idls.pickle'):
            ...
            geo_corpus, geo_corpus_dict = get_corpus_and_dict4(df = self.df, id_col = 'dataid', 
