...
in order
1. get the user's CV 
2. parse them to get current years' publications only 2019-2020 by default 
...
class service():
    def __init__(self, f_name = 'hulin', l_name = 'wu', m_name = '', path ='service/', years = [2019, 2020, 2021], \
                 pubfile = 'sage/data/20192020/[2019, 2020]_.pickle', exclude_users = '', options = 'mesh', val_ratio = 0.2):
        self.f_name = f_name
        self.l_name = l_name
        self.m_name = m_name
        ...
        self.pub_collection = PubCollection(email = 'jzhu8@uth.edu', tool = 'CollabRecommendationSystem')
    ...
    def process(self):
        ...
        """
        save_path = self.path + self.name + '/' + self.options + '/'
