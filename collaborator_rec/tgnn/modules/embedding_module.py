...
class GraphEmbedding(EmbeddingModule):
  ...
  def compute_embedding(self, memory, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
    ...
    source_nodes & timestamps are the numpys
    """
    ...
    source_node_features = self.node_features[source_nodes_torch, :].to(self.device) #modified by ginny 

    if self.use_memory:
      source_node_features = memory[source_nodes, :].to(self.device) + source_node_features #modified by ginny
    ...
    if n_layers == 0:
      ...
      edge_features = self.edge_features[edge_idxs, :].to(self.device) #modified by ginny
