...
class yearly_authors():
    def __init__(self, authfile, years, savepath, options = 'mesh'):  
        ...
        self.year = years
        self.maxLen = 35000 #maximum of pubmed articles, 35000 for [2010, 2011], rest 50000
    ...
    def df_authors(self, date_col = 'pubdate'):
        ...
        # comment out keep consistent for the train validation and test
    ...
    def feature_x(self, options='mesh'):
        ...
        # sort
        self.mapping.sort_values(by ='id', inplace= True, ignore_index=True) #na_position = 'first' or 'last'
